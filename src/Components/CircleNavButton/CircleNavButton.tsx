...
import { Button, Icon, Flex, FlexProps } from '@chakra-ui/core';
...
const CircleNavButton: React.FC<CircleNavButtonProps & Partial<FlexProps>> = ({ navDirection, currentSearch }) => {
    ...
    return (
        <Flex mr="auto" ml="auto">
            <Button rounded="50%" height="16" width="16" color="white" bg="teal.500" onClick={handleClick}>
